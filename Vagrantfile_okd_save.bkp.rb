...
Vagrant.configure(VAGRANTFILE_API_VERSION) do |config|
  ...
  config.vm.define "admin1" do |admin1|
    ...
    admin1.vm.synced_folder "/mnt/c/Users/mamma/Documents/Openshift-Vagrant-Ansible/.vagrant/machines", "/home/vagrant/sync/.vagrant/machines", type: "rsync"
  ...
  SHELL
    ...
    #   ansible.playbook       = '/home/vagrant/sync/4_17_oc.yaml'
