...
if !IS_WSL_USED
  ...
  config.vm.define "admin1" do |admin1|
    ...
    # If WSL is used, point to the Windows file system
  config.vm.synced_folder '/mnt/c/Users/mamma/Documents/Openshift-Vagrant-Ansible', '/home/vagrant/sync'
  config.vm.synced_folder '/mnt/c/Users/mamma/Documents/Openshift-Vagrant-Ansible/.vagrant', '/home/vagrant/.hidden'
